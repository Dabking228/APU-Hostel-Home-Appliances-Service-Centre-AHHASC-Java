...
public class ViewTechAppointments extends javax.swing.JFrame {

    /**
     * Creates new form ViewTechAppointments
     */
    DefaultTableModel model = new DefaultTableModel();

    
    public ViewTechAppointments() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("View Technician Appointment");
        setResizable(false);
